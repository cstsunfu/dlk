...
from dkit.utils.register import Register
from dkit.utils.config import ConfigTool
from dkit.utils.logger import logger
...
class TaskConfigParser(BaseConfigParser):
    ...
    def __init__(self, config_file):
        super(TaskConfigParser, self).__init__(config_file, config_base_dir='dkit/configures/tasks/')
...
class ManagerConfigParser(BaseConfigParser):
    ...
    def __init__(self, config_file):
        super(ManagerConfigParser, self).__init__(config_file, config_base_dir='dkit/configures/managers/')
...
class CallbackConfigParser(BaseConfigParser):
    ...
    def __init__(self, config_file):
        super(CallbackConfigParser, self).__init__(config_file, config_base_dir='dkit/configures/core/callbacks/')
...
class DatamoduleConfigParser(BaseConfigParser):
    ...
    def __init__(self, config_file):
        super(DatamoduleConfigParser, self).__init__(config_file, config_base_dir='dkit/configures/data/datamodules/')
...
class IModelConfigParser(BaseConfigParser):
    ...
    def __init__(self, config_file):
        super(IModelConfigParser, self).__init__(config_file, config_base_dir='dkit/configures/core/imodels/')
...
class ModelConfigParser(BaseConfigParser):
    ...
    def __init__(self, config_file):
        super(ModelConfigParser, self).__init__(config_file, config_base_dir='dkit/configures/core/models/')
...
class OptimizerConfigParser(BaseConfigParser):
    ...
    def __init__(self, config_file):
        super(OptimizerConfigParser, self).__init__(config_file, config_base_dir='dkit/configures/core/optimizers/')
...
class ScheduleConfigParser(BaseConfigParser):
    ...
    def __init__(self, config_file):
        super(ScheduleConfigParser, self).__init__(config_file, config_base_dir='dkit/configures/core/schedulers/')

@config_parser_register('initmethod')
class InitMethodConfigParser(BaseConfigParser):
    """docstring for InitMethodConfigParser"""
    def __init__(self, config_file):
        super(InitMethodConfigParser, self).__init__(config_file, config_base_dir='dkit/configures/core/initmethods/')
...
class LossConfigParser(BaseConfigParser):
    ...
    def __init__(self, config_file):
        super(LossConfigParser, self).__init__(config_file, config_base_dir='dkit/configures/core/losses/')
...
class EncoderConfigParser(BaseConfigParser):
    ...
    def __init__(self, config_file):
        super(EncoderConfigParser, self).__init__(config_file, config_base_dir='dkit/configures/core/layers/encoders/')
...
class DecoderConfigParser(BaseConfigParser):
    ...
    def __init__(self, config_file):
        super(DecoderConfigParser, self).__init__(config_file, config_base_dir='dkit/configures/core/layers/decoders/')
...
class EmbeddingConfigParser(BaseConfigParser):
    ...
    def __init__(self, config_file):
        super(EmbeddingConfigParser, self).__init__(config_file, config_base_dir='dkit/configures/core/layers/embeddings/')
...
class ModuleConfigParser(BaseConfigParser):
    ...
    def __init__(self, config_file):
        super(ModuleConfigParser, self).__init__(config_file, config_base_dir='dkit/configures/core/modules/')

@config_parser_register('processor')
class ProcessorConfigParser(BaseConfigParser):
    """docstring for ProcessorConfigParser"""
    def __init__(self, config_file):
        super(ProcessorConfigParser, self).__init__(config_file, config_base_dir='dkit/configures/data/processors/')
...
class SubProcessorConfigParser(BaseConfigParser):
    ...
    def __init__(self, config_file):
        super(SubProcessorConfigParser, self).__init__(config_file, config_base_dir='dkit/configures/data/subprocessors/')
...
class PostProcessorConfigParser(BaseConfigParser):
    ...
    def __init__(self, config_file):
        super(PostProcessorConfigParser, self).__init__(config_file, config_base_dir='dkit/configures/data/postprocessors/')
