...
from dkit.core.callbacks import callback_register, callback_config_register
    ...
    def get_callbacks_config(self, config):
        ...
        for callback_name in callback_names:
            ...
            if not callback_config:
                callback_config = hjson.load(open(f'dkit/configures/core/callbacks/{callback_name}.hjson', 'r'), object_pairs_hook=dict)
