...
@module_config_register("transformer_attention")
class TransformerAttentionConfig(BaseConfig):
    """Config for TransformerAttention
    ...
    Config Example:
        ...
        >>>     },
        >>>     "_name": "transformer_attention",
        >>> }
    """
    def __init__(self, config: Dict):
        super(TransformerAttentionConfig, self).__init__(config)
...
@module_register("transformer_attention")
class TransformerAttention(Module):
    """Multi-headed attention from 'Attention Is All You Need' paper"""

    def __init__(self, config: TransformerAttentionConfig):
        super().__init__()
        self.embed_dim = config.input_size
        self.num_heads = config.num_heads
