...
@model_config_register('seq2seq')
class Seq2SeqModelConfig(BaseConfig):
    """Config for Seq2SeqModel
    ...
    def __init__(self, config):
        super(Seq2SeqModelConfig, self).__init__(config)
...
@model_register('seq2seq')
class Seq2SeqModel(BaseModel):
    """Seq2Seq & General Model
    """

    def __init__(self, config: Seq2SeqModelConfig, checkpoint: bool):
        super().__init__()
