...
@model_config_register('summary_generate')
class SummaryGenerateModelConfig(BaseConfig):
    """Config for SummaryGenerateModel
    ...
    def __init__(self, config):
        super(SummaryGenerateModelConfig, self).__init__(config)
...
@model_register('summary_generate')
class SummaryGenerateModel(BaseModel):
    """SummaryGenerate & General Model
    """

    def __init__(self, config: SummaryGenerateModelConfig, checkpoint: bool):
        super().__init__()
